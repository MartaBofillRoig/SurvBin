...
for(i in 1:dim(data)[1]){
  ...
  t1=Sys.time()-t0
  cat(i, "\t", t1, "\n", file="LOG_Results_H0_eta.txt", append=TRUE)
  save.image("C:/Users/Marta/Nextcloud/Gitkraken/SurvBin/Code_PAPER/Extension_Simulation/results/RESULTS_PAPER_H0_eta.RData")
  # save.image("C:/Users/mbofi/Dropbox/C5/Scripts/GitKraken/survivalbinary/Code_PAPER/Extension_Simulation/results/RESULTS_PAPER_H0.RData")
}
