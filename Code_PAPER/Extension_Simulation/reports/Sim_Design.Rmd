...
power_plugin <- sum(replicate(nsim,fCS.TEST_H1(a.shape=a, b.scale=b, HR=0.80, rate.param=tau, p0=p0, p1=p1, ass.par=0.5, 
                                               ...
                                               tau=2, taub=1, rho=1, gam=1, eta=1, wb=0.5, ws=0.5, var_est='Pooled')) > z.alpha,na.rm = T)/nsim  

power_Bonf <- sum(replicate(nsim,(sum(fCS.TEST_Bonf_H1(a.shape=a, b.scale=b, HR=0.80, rate.param=tau, p0=p0, p1=p1, ass.par=0.5, 
                                                       n0=500, n1=500, censoring="Unif", 
